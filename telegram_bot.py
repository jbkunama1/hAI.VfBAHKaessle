...
"
    ...
    async def link(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        row = cur.fetchone()
        if row is None:
            await update.message.reply_text("Benutzername nicht gefunden. Bitte zuerst im Web registrieren.")
            conn.close()
            return
        ...
        conn.commit()
        conn.close()
        await update.message.reply_text(f"Telegram-Konto mit Benutzer '{username}' verknüpft.")
